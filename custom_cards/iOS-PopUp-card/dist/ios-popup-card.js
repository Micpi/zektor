    ...
    cards: [
      {
        ...
        description: "Tuile compacte et moderne",
      },
      {
        type: "button",
        name: "Bouton",
      ...
      { type: "entities", name: "Entités", icon: "mdi:view-list", description: "Liste d'entités" },
      {
        ...
        description: "Contrôle d'éclairage",
      },
      {
        type: "thermostat",
        name: "Thermostat",
        icon: "mdi:thermostat",
        description: "Contrôle de climatisation",
      },
      {
        type: "media-control",
        name: "Lecteur média",
        icon: "mdi:cast",
        description: "Contrôle multimédia",
      },
      {
  ...
  },
  {
    ...
    cards: [
      { type: "grid", name: "Grille", icon: "mdi:grid", description: "Organiser en grille" },
      {
        ...
        description: "Cartes en ligne",
      },
      {
        type: "vertical-stack",
        name: "Stack vertical",
        icon: "mdi:arrow-split-horizontal",
        description: "Cartes en colonne",
      },
      {
        type: "conditional",
        name: "Conditionnel",
    ...
    cards: [
      {
        ...
        name: "Light",
        icon: "mdi:lightbulb",
        description: "Carte lumière Mushroom",
      },
      {
        type: "custom:mushroom-entity-card",
        name: "Entity",
        icon: "mdi:square-rounded",
        description: "Carte entité Mushroom",
      },
      {
        type: "custom:mushroom-fan-card",
        name: "Fan",
        icon: "mdi:fan",
        description: "Carte ventilateur Mushroom",
      },
      {
        type: "custom:mushroom-climate-card",
        name: "Climate",
        icon: "mdi:thermostat",
        description: "Carte climat Mushroom",
      },
      {
        type: "custom:mushroom-cover-card",
        name: "Cover",
        icon: "mdi:blinds-horizontal",
        description: "Carte volet Mushroom",
      },
      {
        type: "custom:mushroom-chips-card",
        name: "Chips",
        icon: "mdi:checkbox-multiple-blank-outline",
        description: "Puces Mushroom",
      },
      {
        type: "custom:mushroom-alarm-control-panel-card",
        name: "Alarm",
        icon: "mdi:shield-outline",
        description: "Carte alarme Mushroom",
      },
      {
        type: "custom:mushroom-template-card",
        name: "Template",
        icon: "mdi:code-braces",
        description: "Carte template Mushroom",
      },
      {
        type: "custom:mushroom-media-player-card",
        name: "Media Player",
        icon: "mdi:play-circle-outline",
        description: "Lecteur média Mushroom",
      },
      {
        type: "custom:mushroom-lock-card",
        name: "Lock",
        icon: "mdi:lock-outline",
        description: "Carte serrure Mushroom",
      },
      {
        type: "custom:mushroom-number-card",
        name: "Number",
        icon: "mdi:ray-vertex",
        description: "Carte nombre Mushroom",
      },
      {
        type: "custom:mushroom-select-card",
        name: "Select",
        icon: "mdi:format-list-bulleted",
        description: "Carte sélection Mushroom",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        name: "Button Card",
        icon: "mdi:gesture-tap-button",
        description: "Bouton hautement personnalisable",
      },
      {
        type: "custom:mini-graph-card",
        name: "Mini Graph",
        icon: "mdi:chart-line",
        description: "Graphique compact",
      },
      {
        type: "custom:mini-media-player",
        name: "Mini Media Player",
        icon: "mdi:play-circle-outline",
        description: "Lecteur média compact",
      },
      {
        type: "custom:stack-in-card",
        name: "Stack in Card",
        icon: "mdi:cards-outline",
        description: "Stack dans une seule carte",
      },
      {
        type: "custom:swipe-card",
        name: "Swipe Card",
        icon: "mdi:gesture-swipe-horizontal",
        description: "Carte avec swipe",
      },
      {
      ...
      },
      {
        ...
        description: "Entités auto-filtrées",
      },
      {
      ...
      },
      {
        ...
        description: "Mise en page avancée",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        description: "Texte formaté Markdown",
      },
      { type: "picture", name: "Image", icon: "mdi:image", description: "Afficher une image" },
      {
        ...
        description: "Image liée à une entité",
      },
      ...
      { type: "gauge", name: "Jauge", icon: "mdi:gauge", description: "Jauge circulaire" },
      {
        ...
        description: "Graphique d'historique",
      },
      {
        type: "statistics-graph",
        name: "Statistiques",
        icon: "mdi:chart-bar",
        description: "Graphique statistiques",
      },
      {
        type: "logbook",
        name: "Journal",
      ...
      },
      {
        ...
        name: "Calendrier",
        icon: "mdi:calendar",
        description: "Événements calendrier",
      },
      {
        type: "todo-list",
...
class IOSPopupCardEditor extends HTMLElement {
  ...
  disconnectedCallback() {
    ...
    // Note: Forms and editors are managed by _render() lifecycle
    try {
      // Clean up any remaining event listeners when editor is destroyed
      if (this._forms) {
  ...
  setConfig(config) {
    ...
    // Only re-render on first load OR if structure changed (cards added/removed/reordered)
    // For simple value changes in forms, just update the form data in-place to preserve focus
    if (!this._didInitialRender) {
      this._render()
    } else {
      // Check if cards array changed (added, removed, or reordered)
      const cardsChanged =
        JSON.stringify(prevConfig.cards || []) !== JSON.stringify(nextConfig.cards || [])

      if (cardsChanged) {
        // Structural change - need full re-render
        this._render()
      } else {
        // Only form values changed - just update the data without re-rendering
  ...
  _updateFormData() {
    // Update form data in-place without re-rendering the entire editor
    // Only proceed if forms have been created
    if (!this._forms) return

    if (this._forms.trigger) {
      try {
        this._forms.trigger.data = { hash: this._config.hash || "" }
      } catch (_) {}
    }
    if (this._forms.header) {
      try {
        this._forms.header.data = {
          ...
          sub_btn_1_double_tap_action: this._config.sub_btn_1_double_tap_action || {
            action: "none",
          },
          ...
          sub_btn_2_double_tap_action: this._config.sub_btn_2_double_tap_action || {
            action: "none",
          },
        }
      } catch (_) {}
    }
    if (this._forms.appearance) {
      try {
        this._forms.appearance.data = {
    ...
    if (this._forms.interactions) {
      try {
        this._forms.interactions.data = {
  ...
  _bindConfigForms() {
    ...
    // ── Déclencheur ──
    this._forms.trigger = this._createForm("form-trigger", { hash: this._config.hash || "" }, [
      { name: "hash", label: "Hash (ex: salon, lumiere)", selector: { text: {} } },
    ])

    // ── En-tête ──
    this._forms.header = this._createForm(
      "form-header",
      {
        title: this._config.title || "",
        subtitle: this._config.subtitle || "",
      ...
      [
        ...
        },
        {
          ...
          label: "Fond de l'icône (CSS, ex: none)",
          selector: { text: {} },
        },
        ...
        {
          name: "sub_btn_1_hold_action",
          label: "Sub button 1 — Hold",
          selector: { ui_action: {} },
        },
        {
          name: "sub_btn_1_double_tap_action",
          label: "Sub button 1 — Double tap",
          selector: { ui_action: {} },
        },
        ...
        {
          name: "sub_btn_2_hold_action",
          label: "Sub button 2 — Hold",
          selector: { ui_action: {} },
        },
        {
          name: "sub_btn_2_double_tap_action",
          label: "Sub button 2 — Double tap",
          selector: { ui_action: {} },
        },
      ]
    )
    ...
    // ── Apparence ──
    this._forms.appearance = this._createForm(
      "form-appearance",
      {
        popup_background: this._config.popup_background || "rgba(28, 28, 30, 0.92)",
        scrim_background: this._config.scrim_background || "rgba(0, 0, 0, 0.4)",
    ...
    // ── Interactions ──
    this._forms.interactions = this._createForm(
      "form-interactions",
      {
        swipe_to_close: this._config.swipe_to_close !== false,
        close_on_scrim: this._config.close_on_scrim !== false,
  ...
  _createForm(containerId, data, schema) {
    ...
    const existingForm = container.querySelector("ha-form")
    if (existingForm) {
      try {
  ...
  _renderAddCardDropdown() {
    ...
    help.id = "picker-hint"
    help.innerHTML =
      '<ha-icon icon="mdi:information-outline"></ha-icon> Sélecteur natif Home Assistant'
    ...
    addBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        if (!opened) {
          help.innerHTML =
            '<ha-icon icon="mdi:alert-circle-outline"></ha-icon> Impossible d\'ouvrir le sélecteur natif sur cette vue.'
        }
      } finally {
        setTimeout(() => {
  ...
  _renderCardsList() {
    ...
    cards.forEach((_, i) => {
      ...
      if (panel) {
        panel.addEventListener("expanded-changed", (ev) => {
          ev.stopPropagation()
          const isExpanded =
            ev.detail && ev.detail.expanded !== undefined
              ? ev.detail.expanded
              : ev.target
                ? ev.target.expanded
                : false
    ...
    cards.forEach((_, i) => {
      ...
      if (textarea) {
        // Store original value to detect actual changes (not re-renders)
        if (!textarea._originalValue) {
          textarea._originalValue = textarea.value
        }

        textarea.addEventListener("blur", () => {
          // Only save if textarea content actually changed
          if (textarea.value !== textarea._originalValue) {
            this._saveCardFromTextarea(i)
            textarea._originalValue = textarea.value
          }
        })
  ...
  async _loadNativeEditor(idx) {
    ...
    if (this._nativeEditors[idx]) {
      try {
        this._nativeEditors[idx].hass = this._hass
      } catch (_) {}
      try {
        this._nativeEditors[idx].setConfig(cardConfig)
      } catch (_) {}
      return
    }

    const isCustom = cardConfig.type.startsWith("custom:")
    const tag = isCustom ? cardConfig.type.substring(7) : "hui-" + cardConfig.type + "-card"
    ...
    try {
      ...
      const helpers = await Promise.race([
        ...
        new Promise(function (_, rej) {
          setTimeout(function () {
            rej(new Error("loadCardHelpers timeout"))
          }, 5000)
        }),
      ])
        ...
        try {
          ...
          if (result instanceof Promise) {
            editorEl = await Promise.race([
              ...
              new Promise(function (_, rej) {
                setTimeout(function () {
                  rej(new Error("getConfigElement timeout"))
                }, 4000)
              }),
            ])
          } else {
      ...
      if (editorEl) {
        ...
        if (
          editorEl.localName &&
          editorEl.localName.includes("-") &&
          !customElements.get(editorEl.localName)
        ) {
          await Promise.race([
...
class IOSPopupCard extends HTMLElement {
  ...
  setConfig(config) {
    ...
    this._config = {
      ...
      sub_btn_1_tap_action:
        config.sub_btn_1_tap_action ||
        this._targetToAction(config.sub_btn_1_tap_target || config.sub_btn_1_target),
      sub_btn_1_hold_action:
        config.sub_btn_1_hold_action || this._targetToAction(config.sub_btn_1_hold_target),
      sub_btn_1_double_tap_action:
        config.sub_btn_1_double_tap_action ||
        this._targetToAction(config.sub_btn_1_double_tap_target),
      sub_btn_2_tap_action:
        config.sub_btn_2_tap_action ||
        this._targetToAction(config.sub_btn_2_tap_target || config.sub_btn_2_target),
      sub_btn_2_hold_action:
        config.sub_btn_2_hold_action || this._targetToAction(config.sub_btn_2_hold_target),
      sub_btn_2_double_tap_action:
        config.sub_btn_2_double_tap_action ||
        this._targetToAction(config.sub_btn_2_double_tap_target),
  ...
  _detectContext() {
    ...
    try {
      ...
      const lovelaceEdit = Boolean(
        huiRoot?.lovelace?.editMode || panel?.lovelace?.editMode || huiRoot?.editMode
      )
  ...
  _buildCard() {
    ...
    const iconBackground =
      cfg.icon_background !== undefined && cfg.icon_background !== null
        ? cfg.icon_background
  ...
  async _renderPreviewCards() {
    ...
    for (const cardConfig of this._config.cards) {
      ...
      try {
        ...
        el.style.cssText =
          "color:#FF453A;padding:8px;font-size:12px;background:rgba(255,69,58,0.1);border-radius:8px;"
      }
      if (el) {
        if (this._hass) el.hass = this._hass
  ...
  async _openPopup() {
    ...
    const _borderParts = String(cfg.border_radius || "")
      .split(/\s+/)
      .filter(Boolean)
    ...
    if (cfg.swipe_to_close) {
      ...
      this._swipeCleanup = () => {
        /* pointer capture — pas de listeners globaux */
      }
    }
  ...
  async _renderCards(container) {
    ...
    for (const cardConfig of this._config.cards) {
      ...
      try {
        ...
        el.style.cssText =
          "color:#FF453A;padding:12px;font-size:13px;background:rgba(255,69,58,0.1);border-radius:10px;"
      }
...
window.customCards.push({
  ...
  name: "iOS Popup Card",
  description:
    "Popup iOS bottom-sheet déclenché par hash navigation (#popup-xxx). Carte invisible.",
  preview: false,
